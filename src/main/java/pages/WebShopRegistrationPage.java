...
public class WebShopRegistrationPage {
	...
	public void verifyRegistrationPage_Title(String Title) {
		...
		runtime.library.AssertStringsEqual_True(
				runtime.library.readText(wSRegistrationPage_Title, "REgistration page title"), Title);
	}
	...
	public void verifyRegistrationSuccessMessage(String Message) {
		runtime.library.AssertStringsEqual_True(
				runtime.library.readText(wSRegistrationPage_RegisterSuccessMessage, "Registration Success Message"),
				Message);
	}
