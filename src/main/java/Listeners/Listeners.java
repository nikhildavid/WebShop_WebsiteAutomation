...
//		ITestListener.super.onTestStart(result);
		...
		// threadsafeTest.set(test); //unique thread id is set for the 'test' (each java
		// execution will have its own unique thread id)
	}
...
//		ITestListener.super.onTestFailure(result);
		...
		// threadsafeTest.get().fail(result.getThrowable()); //to get the test object of
		// exact Test method
